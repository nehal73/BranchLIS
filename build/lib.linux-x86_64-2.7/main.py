...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "hi:l:t:p:o:w:d:f:", ["ifile=", "lim=","timeout=","temp=","opt=", "width=", "depth=","folder="])
    ...
    if option == 1:
        ...
        heuristic(file_name,temp_path)
        local_improve(file_name,limit_on_size,time_out,temp_path,second=1)
